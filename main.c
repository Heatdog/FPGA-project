...
void round_of_feistel_cipher(uint32_t * block32b_1, uint32_t * block32b_2, const uint32_t * keys32b, uint8_t round);
...
void round_of_feistel_cipher(uint32_t * block32b_1, uint32_t * block32b_2, const uint32_t * keys32b, uint8_t round) { /*сам раунд шифрования в сети
Фейстеля*/
